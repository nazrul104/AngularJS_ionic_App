...
var api_url="http://smartrestaurantsolutions.com/mobileapi-test/";
 ...
 var platform =1;//ios=1,android=2
 ...
 var userComments="";
    return {
       ...
       getNumOfCartItem:function()
        ...
        setRestaurantOpenStatusString:function(s)
        {
            str=s;
        },
        getRestaurantOpenStatusString:function()
        {
            return str;
        },
        setPOP:function(open)
        {
            open_pop=open_pop+open;
        },
        getPOP:function()
        {
            return open_pop;
        ...
        setPreorderTime:function(pretime)
        {
            preorder_time = pretime;
        },
        getPreorderTime:function()
        {
           return preorder_time;
        },
        setPayPal_pending_status:function(pay)
        {
            isPayPal = pay;
        },
        getPayPal_pending_status:function()
        {
            return isPayPal;
        },
